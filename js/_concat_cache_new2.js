...
/**
 * Created by louistar on 12/19/14.
 */
(function(e) {
...
var getSiteSettings = function() {
    return {
        ...
        "performers": {
            ...
            "refreshingInterval": 120000,
            "loadPerPage": 20,
            "loadMoreButtonId": "load-more-btn",
            "ajaxLoadingId": "ajax-loading",
            "ajaxLoadingWrapperId": "ajax-loading-wrapper",
            "mainId": "main",
            "wrapperId": "main-wrap",
            "ajaxWrapperId": "load-more",
            "userIconClassName": "icon_user",
            "pageNumberId": "pagenum",
            "performerContainerClassName": "user-div-handle",
            "userIndexClassName": "save-user-index",
            "mostPopularSection": {
                "isRefreshingActive": false,
                "refreshingInterval": 180000,
                "itemLimit": 5,
                "wrapperId": "popul_items",
                "performerContainerClassName": "list-item",
                "ajaxUrl": "/ajax-most-popular.php"
            }
        },
        "thumbnails": {
            "isDynamicPreviewActive": false,
            "previewUrl": "https://cbjpeg-serve.stream.highwebmedia.com/stream?room={username}&f=0.14013778239328656&rand=0",
            "preloaderImageUrl": "/images/preloader.svg",
            "privateShowImageUrl": "/images/private_show.png",
            "hoverElementClassName": "user_div",
            "hoverImageClassName": "u_img",
        ...
        "player": {
            "isActive": true,
            "userUrl": "https://nudelive.com/user/{username}/",
            "ajaxUrl": "/ajax.php",
            "ajaxRandomUrl": "/ajax-random.php",
            "ajaxScrollUrl": "/ajax_scroll_v3.php",
            "randomCamsUrl": "random-cams",
            "playerUrl": "//cams.nudelive.com/affiliates/in/9oGW/066fa/?track=nudelive-embd&bgcolor=white&room=",
            "playerData": {
                "get_random_user": 1
            },
            "playerText": "Would you like to login? Click 'Stay' to prevent redirect.",
            "buttonId": "next_btn_random",
            "iframePostLoaderClassName": "iframe_postloader",
            "iframeId": "live_cam_frame",
            "buttonNextId": "next_btn",
            "buttonPrevId": "prev_btn",
            "frame": {
                "iframeWrapperId": "iframe_wrapper",
                "maxWindowWidth": 850,
                "scaleFactor": 800,
                "widthFactor": 0.98,
                "heightFactor": 528,
        ...
        "mobileMenu": {
            "buttonJQueryExpression": ".toggle_but_top, .toggle_but_top span",
            "navListClassName": "nav-list",
            "activeClassName": "open"
        },
        "welcomeModal": {
            "modalEnterId": "modal_enter",
            "bgId": "bg_popup",
            "modalClassName": "main_mod",
            "cookie": "popup_camvoya"
        },
        "bline": {
            "useBline": true,
            "blineNoticeId": "bline_notice",
            "dismissBlineNoticeId": "dismiss_bline_notice",
            "cookie": "supress_bline"
        }
    };
};
!function(t) {
    ...
    t.fn.countTo = function(e) {
        ...
        t(this).each(function() {
            function a() {
                ...
                c++,
                n(d),
                "function" == typeof o.onUpdate && o.onUpdate.call(f, d),
                c >= r && (i.removeData("countTo"),
                clearInterval(s.interval),
                d = o.to,
                "function" == typeof o.onComplete && o.onComplete.call(f, d))
            }
            function n(t) {
            ...
            s.interval = setInterval(a, o.refreshInterval),
            n(d)
        })
    }
    ,
    ...
    i.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (h) {
                ...
                a = "bottom" == a && p.bottom + c > d.bottom ? "top" : "top" == a && p.top - c < d.top ? "bottom" : "right" == a && p.right + f > d.width ? "left" : "left" == a && p.left - f < d.left ? "right" : a,
                s.removeClass(u).addClass(a)
            }
            var v = this.getCalculatedOffset(a, p, f, c);
...
function pageCounter() {
    $('.aps-item').each(function() {

        var oTop = $(this).offset().top - window.innerHeight;
        if ($(this).data("counter") != 1 && $(window).scrollTop() > oTop + 50) {
            $(this).children(".about-counter").countTo({
                speed: 555,
                refreshInterval: 2
            });
            $(this).data("counter", 1);
...
$(document).ready(function() {
    ...
    $("#mob-menu").on("click", function() {
        $("body").toggleClass("wpb-open");

        $('#mobile-search-toggle').removeClass('clicked');
        $('#header-search-holder-mobile').slideUp(150);
        $(".wpb-mobile-sub ul").slideUp();
    });

    $(".wpb-overlay").on("click", function() {
        $("body").removeClass("wpb-open");
        $(".wpb-mobile-sub ul").slideUp();
    });

    $(".wpb-mobile-sub span").on("click", function() {
        $(".wpb-mobile-sub ul").slideToggle();
    });

    // Counter Performer Info
    //--------------------------------------------------------------------------
    var timer_count = $('.timer');
    var count_item = $('.counter-item');
    $(document).one("click", count_item, function() {
        timer_count.countTo();
    });
    ...
    $('.fpc-item b').on("click", function() {
        if (!$(this).hasClass("active")) {
            $('.fpc-item b').removeClass("active");
            $('.fpc-item p').slideUp();
        }
    ...
    // Mobile Intro text
    //--------------------------------------------------------------------------
    $(".mob-intro").on("click", function() {
        $(".page-header .lead").slideToggle();
    });
    ...
    $('#mobile-search-toggle').on('click', function() {
        ...
        $('#header-search-holder-mobile').slideToggle(250);

    });

    var userAgent = navigator.userAgent;
    if (typeof ($.cookie) !== 'undefined' && !($.cookie('supress_bline')) && userAgent.indexOf('bline') == -1 && (userAgent.indexOf('iPhone') >= 0 || userAgent.indexOf('iPod') >= 0)) {
        $('#bline_notice').show();
    }
    ...
    $('#dismiss_bline_notice').click(function(e) {
        e.preventDefault();
        $('#bline_notice').hide();
        $.cookie('supress_bline', 1, {
            expires: 30,
            path: '/'
        });
    });

    // Submit Filter form on selector change
    $('.filter-trigger').on('change', function() {
        $('#sort_form').submit();
    });
    $('#filter-looking-for-select').on('change', function() {
        location = this.options[this.selectedIndex].value;
    });
    $("#cat_sel_mob").on('change', function() {
        location = this.options[this.selectedIndex].value;
...
$("#close-modal-warning").click(function() {
    $.cookie("popup_nudelive", "month", {
        expires: 30,
        path: '/'
    });
    $("#modal-warning").hide();
...
var hoverInternal1, hoverInternal2, siteSettings = getSiteSettings(), microtime = {
    start: 0,
    end: 0
}, preventedReload = !1, isLoading = !1, doNotScroll = !0, strState = "no", globalChangingAllowed = !0, updateDefined = null, updateDefined2 = null, globalPagesLoaded = 1, lastMouseActivity = new Date, performersInterval = null, firstTimeLoaded = !0, lastScrollTop = window.pageYOffset || window.scrollTop, forcedScroll = !1;
function hashCode(e) {
...
if ("function" != typeof resizeFrame) {
    function resizeFrame() {
        var e = $(window).width()
          , t = $("#" + siteSettings.player.frame.iframeWrapperId);
        if (t.length > 0)
            if (e > siteSettings.player.frame.maxWindowWidth)
                t.css(siteSettings.player.frame.defaultCss);
            else {
                var r = e * siteSettings.player.frame.widthFactor
                  , s = r / siteSettings.player.frame.scaleFactor
                  , n = s * siteSettings.player.frame.heightFactor;
                t.css({
                    width: r + "px",
                    height: n + "px",
...
function setFilterCookie(e) {
    var t = btoa(unescape(encodeURIComponent(JSON.stringify(e))));
    document.cookie = "last_filter=" + t + "; path=/"
}
function setLastIndexCookie(e) {
    var t = e;
    document.cookie = "last_index=" + t + "; path=/"
}
function playerLoadNextPerformer() {
    microtime.start = +new Date,
    document.getElementById(siteSettings.player.buttonNextId) ? (document.getElementById(siteSettings.player.buttonNextId).dataset.disb = "true",
    document.getElementById(siteSettings.player.buttonNextId).style.cursor = "default",
    $.ajax({
        url: siteSettings.player.ajaxUrl,
        type: "POST",
        data: "undefined" != typeof filter_ajax ? filter_ajax : siteSettings.player.playerData,
        success: function(e) {
            var t = $.parseJSON(e);
            "undefined" != typeof filter_ajax && setFilterCookie(filter_ajax),
            t && t.username && t.username.length > 0 ? window.location.href = siteSettings.player.userUrl.replace("{username}", t.username) : alert("This is the last performer on the list!")
        },
        error: function(e) {
            if ($("#" + siteSettings.player.buttonNextId).fadeIn(),
            !0 === siteSettings.debugMode) {
                var t = JSON.stringify(e);
                console.log("error: " + t)
            }
        }
    })) : document.getElementById(siteSettings.player.buttonId) && ($("." + siteSettings.player.iframePostLoaderClassName).fadeIn(),
    $.ajax({
        url: siteSettings.player.ajaxRandomUrl,
        type: "POST",
        data: siteSettings.player.playerData,
        success: function(e) {
            var t = $.parseJSON(e);
            document.getElementById(siteSettings.player.iframeId).src = siteSettings.player.playerUrl + t.username,
            $("#" + siteSettings.player.iframeId).on("load", function() {
                $("." + siteSettings.player.iframePostLoaderClassName).fadeOut()
            })
        },
        error: function(e) {
            if (!0 === siteSettings.debugMode) {
                var t = JSON.stringify(e);
                console.log("error: " + t)
            }
            $("." + siteSettings.player.iframePostLoaderClassName).fadeOut()
...
function playerLoadPreviousPerformer() {
    microtime.start = +new Date,
    document.getElementById(siteSettings.player.buttonPrevId) && (document.getElementById(siteSettings.player.buttonPrevId).dataset.disb = "true",
    document.getElementById(siteSettings.player.buttonPrevId).style.cursor = "default",
    $.ajax({
        url: siteSettings.player.ajaxUrl + "?prev=true",
        type: "POST",
        data: "undefined" != typeof filter_ajax ? filter_ajax : siteSettings.player.playerData,
        success: function(e) {
            var t = $.parseJSON(e);
            "undefined" != typeof filter_ajax && setFilterCookie(filter_ajax),
            t && t.username && t.username.length > 0 ? window.location.href = siteSettings.player.userUrl.replace("{username}", t.username) : alert("This is the first performer on the list!")
        },
        error: function(e) {
            if ($("#" + siteSettings.player.buttonPrevId).fadeIn(),
            !0 === siteSettings.debugMode) {
                var t = JSON.stringify(e);
                console.log("error: " + t)
            }
...
function updateThumbnailHovers() {
    if (refreshPerformerIndexes(),
    !0 === siteSettings.thumbnails.isDynamicPreviewActive)
        for (var e = document.getElementsByClassName(siteSettings.thumbnails.hoverElementClassName), t = 0; t < e.length; t++)
            e[t].dataset.loaded || (e[t].dataset.loaded = "true",
            e[t].addEventListener("mouseenter", function() {
                if (!this.getElementsByClassName(siteSettings.thumbnails.tempImageClassName)[0]) {
                    globalChangingAllowed = !1,
                    clearInterval(hoverInternal1),
                    clearInterval(hoverInternal2),
                    document.getElementById("hoverId") && $("#hoverId").remove();
                    var e = this.getElementsByClassName(siteSettings.thumbnails.hoverElementContainer)[0];
                    e.style.position = "relative",
                    e.style.overflow = "hidden",
                    e.style.display = "block";
                    var t = document.createElement("div");
                    t.style.position = "absolute",
                    t.style.background = "transparent url(" + siteSettings.thumbnails.preloaderImageUrl + ") center center no-repeat",
                    t.style.backgroundSize = "100% 100%",
                    t.style.width = "100%",
                    t.style.height = "100%",
                    t.id = "hoverId";
                    var r = siteSettings.thumbnails.previewUrl.replace("{username}", this.dataset.username)
                      , s = (this.dataset.username,
                    new Image);
                    t.innerHTML = '<img id="hover_img1" src="' + r + '" style="width: 100%; height: 100%; opacity: 1; position: absolute; top: 0; left: 0;" alt=""><img id="hover_img2" src="' + r + '" style="width: 100%; height: 100%; opacity: 0.3; position: absolute; top: 0; left: 0;" alt="">',
                    e.insertBefore(t, e.getElementsByClassName(siteSettings.thumbnails.hoverImageClassName)[0]),
                    s.onload = function() {
                        clearInterval(hoverInternal1),
                        clearInterval(hoverInternal2),
                        hoverInternal1 = setInterval(function() {
                            if (document.getElementById("hover_img1")) {
                                var e = document.getElementById("hover_img1").src.split("&rand=")[0];
                                e = e + "&rand=" + Math.random(),
                                document.getElementById("hover_img1").src = e
                            }
                        }, 250),
                        hoverInternal2 = setInterval(function() {
                            if (document.getElementById("hover_img2")) {
                                var e = document.getElementById("hover_img2").src.split("&rand=")[0];
                                e = e + "&rand=" + Math.random(),
                                document.getElementById("hover_img2").src = e
                            }
                        }, 250)
                    }
                    ,
                    s.onerror = function() {
                        if (clearInterval(hoverInternal1),
                        clearInterval(hoverInternal2),
                        document.getElementById("hoverId")) {
                            document.getElementById("hoverId").style.background = "black url(" + siteSettings.thumbnails.privateShowImageUrl + ") center center no-repeat",
                            document.getElementById("hoverId").style.backgroundSize = "contain";
                            for (var e = document.getElementById("hoverId").children, t = 0; t < e.length; t++)
            ...
            e[t].addEventListener("mouseleave", function() {
...
function removeOldPerformers() {
    var e = !1;
    if (document.getElementById(siteSettings.performers.wrapperId)) {
        e = !0;
        var t = document.getElementById(siteSettings.performers.wrapperId).children
    } else if (document.getElementsByClassName(siteSettings.performers.wrapperId)) {
        e = !0;
        t = document.getElementsByClassName(siteSettings.performers.wrapperId)[0].children
    }
    if (e)
        for (var r = 0; r < t.length; r++)
            (-1 != t[r].className.indexOf(siteSettings.performers.performerContainerClassName) || t[r].children[0] && -1 != t[r].children[0].className.indexOf(siteSettings.performers.performerContainerClassName)) && ($(t[r]).remove(),
            r--)
}
function removeMostPopularPerformers() {
    var e = !1;
    if (document.getElementById(siteSettings.performers.mostPopularSection.wrapperId)) {
        e = !0;
        var t = document.getElementById(siteSettings.performers.mostPopularSection.wrapperId).children
    } else if (document.getElementsByClassName(siteSettings.performers.mostPopularSection.wrapperId)) {
        e = !0;
        t = document.getElementsByClassName(siteSettings.performers.mostPopularSection.wrapperId)[0].children
    }
    if (e)
        for (var r = 0; r < t.length; r++)
            (-1 != t[r].className.indexOf(siteSettings.performers.mostPopularSection.performerContainerClassName) || t[r].children[0] && -1 != t[r].children[0].className.indexOf(siteSettings.performers.mostPopularSection.performerContainerClassName)) && ($(t[r]).remove(),
            r--)
}
function refreshPerformers() {
    if (!0 === siteSettings.performers.isRefreshingActive && document.getElementById(siteSettings.performers.wrapperId)) {
        var e = JSON.parse(JSON.stringify(filter_ajax));
        e.pagenum = 0,
        e.item_limit = globalPagesLoaded,
        $.ajax({
            type: "POST",
            url: siteSettings.player.ajaxScrollUrl,
            data: e,
            success: function(e) {
                var t = hashCode(e);
                if (null === updateDefined)
                    !0 === siteSettings.debugMode && console.log("-----first up-----"),
                    updateDefined = t;
                else if (updateDefined != t && e.length > 10)
                    if (globalChangingAllowed) {
                        !0 === siteSettings.debugMode && console.log("-----updating performers-----");
                        var r = !1;
                        if (document.getElementById(siteSettings.performers.wrapperId)) {
                            r = !0;
                            var s = document.getElementById(siteSettings.performers.wrapperId)
                        } else if (document.getElementsByClassName(siteSettings.performers.wrapperId)) {
                            r = !0;
                            s = document.getElementsByClassName(siteSettings.performers.wrapperId)[0]
                        }
                        if (r) {
                            var n = !1;
                            !1 === doNotScroll && (doNotScroll = !0,
                            n = !0),
                            removeOldPerformers(),
                            $(s).prepend($("<span></span>" + e)),
                            updateThumbnailHovers(),
                            "function" == typeof reloadPlugins && reloadPlugins(),
                            !0 === n && (doNotScroll = !1)
                        }
                        updateDefined = t
                    } else
                        !0 === siteSettings.debugMode && console.log("-----user is hovering - updating paused-----");
                else
                    !0 === siteSettings.debugMode && console.log("-----no changes-----")
            },
            error: function(e) {
                !0 === siteSettings.debugMode && console.error(e)
            }
        })
    }
}
function refreshMostPopularPerformers() {
    if (siteSettings.performers.mostPopularSection && !0 === siteSettings.performers.mostPopularSection.isRefreshingActive && document.getElementById(siteSettings.performers.mostPopularSection.wrapperId)) {
        !0 === siteSettings.debugMode && console.log("Updating most popular performers");
        var e = filter_ajax;
        e.pagenum = 1,
        e.item_limit = siteSettings.performers.mostPopularSection.itemLimit,
        $.ajax({
            type: "POST",
            url: siteSettings.performers.mostPopularSection.ajaxUrl,
            data: e,
            success: function(e) {
                var t = hashCode(e);
                if (null === updateDefined2)
                    !0 === siteSettings.debugMode && console.log("-----first up-----"),
                    updateDefined2 = t;
                else if (updateDefined2 != t)
                    if (globalChangingAllowed) {
                        !0 === siteSettings.debugMode && console.log("-----updating performers-----");
                        var r = !1;
                        if (document.getElementById(siteSettings.performers.mostPopularSection.wrapperId)) {
                            r = !0;
                            var s = document.getElementById(siteSettings.performers.mostPopularSection.wrapperId)
                        } else if (document.getElementsByClassName(siteSettings.performers.mostPopularSection.wrapperId)) {
                            r = !0;
                            s = document.getElementsByClassName(siteSettings.performers.mostPopularSection.wrapperId)[0]
                        }
                        if (r) {
                            var n = !1;
                            !1 === doNotScroll && (doNotScroll = !0,
                            n = !0),
                            removeMostPopularPerformers(),
                            $(s).prepend($("<span></span>" + e)),
                            updateThumbnailHovers(),
                            "function" == typeof reloadPlugins && reloadPlugins(),
                            !0 === n && (doNotScroll = !1)
...
function refreshPerformerIndexes() {
    if (siteSettings.performers.userIndexClassName)
        for (var e = document.getElementsByClassName(siteSettings.performers.userIndexClassName), t = 0; t < e.length; t++)
            e[t].dataset.saved || (e[t].dataset.saved = "true",
            e[t].addEventListener("click", function() {
                this.dataset.disb || setLastIndexCookie(this.dataset.indexId)
            }))
}
function startRefreshingPerformers() {
    if (!0 === siteSettings.performers.isRefreshingActive && (!0 === siteSettings.debugMode && console.log("-----Starting refreshing performers-----"),
    performersInterval = setInterval(function() {
        var e = new Date
          , t = (lastMouseActivity.getTime() - e.getTime()) / 1e3
          , r = Math.abs(t);
        !0 === siteSettings.debugMode && console.log("Seconds_Between_Dates =", r),
        r <= 60 ? (!0 === siteSettings.debugMode && console.log("-----Refreshing performers now...-----"),
        refreshPerformers()) : r > 180 && (!0 === siteSettings.debugMode && console.log("-----Refreshing performers aborted due to user inactivity-----"),
        clearInterval(performersInterval))
    }, siteSettings.performers.refreshingInterval)),
    !0 === siteSettings.performers.mostPopularSection.isRefreshingActive) {
        var e = !1;
        document.getElementById(siteSettings.performers.mostPopularSection.wrapperId) ? e = !0 : document.getElementsByClassName(siteSettings.performers.mostPopularSection.wrapperId) && (e = !0),
        e && (refreshMostPopularPerformers(),
        setInterval(refreshMostPopularPerformers, siteSettings.performers.mostPopularSection.refreshingInterval))
    }
}
startRefreshingPerformers(),
updateThumbnailHovers(),
$(document).ready(function() {
    if (lastScrollTop = window.pageYOffset || window.scrollTop,
    document.onmousemove = function(e) {
        lastMouseActivity = new Date
    }
    ,
    -1 != window.location.href.indexOf(siteSettings.player.randomCamsUrl) && playerLoadNextPerformer(),
    resizeFrame(),
    !0 === siteSettings.player.isActive && (document.getElementById(siteSettings.player.buttonId) && document.getElementById(siteSettings.player.buttonId).addEventListener("click", function(e) {
        return e.preventDefault(),
        playerLoadNextPerformer(),
        !1
    }),
    document.getElementById(siteSettings.player.buttonNextId) && document.getElementById(siteSettings.player.buttonNextId).addEventListener("click", function(e) {
        return e.preventDefault(),
        playerLoadNextPerformer(),
        !1
    }),
    document.getElementById(siteSettings.player.buttonPrevId) && document.getElementById(siteSettings.player.buttonPrevId).addEventListener("click", function(e) {
        return e.preventDefault(),
        playerLoadPreviousPerformer(),
        !1
    })),
    siteSettings.performers.userIndexClassName && refreshPerformerIndexes(),
    !0 === siteSettings.performers.isLoadMoreButtonActive && $("#" + siteSettings.performers.loadMoreButtonId).on("click", function(e) {
        e.preventDefault(),
        doNotScroll = !1,
        $(this).parent().remove(),
        forcedScroll = !0,
    ...
    $(window).scroll(function() {
        if (!doNotScroll)
            if (!0 === siteSettings.performers.isLoadMoreButtonActive) {
                var e = $("#" + siteSettings.performers.mainId).offset()
                  , t = $("#" + siteSettings.performers.ajaxLoadingWrapperId).offset()
                  , r = window.pageYOffset || document.documentElement.scrollTop
                  , s = r > lastScrollTop;
                s = r > lastScrollTop,
                lastScrollTop = r <= 0 ? 0 : r;
                var n = 1.5 * ($(window).scrollTop() + $(window).height()) >= e.top + t.top && !isLoading && s;
                if ((forcedScroll || n) && (forcedScroll = !1,
                !$("#" + siteSettings.performers.ajaxLoadingId).is(":visible"))) {
                    isLoading = !0,
                    $("#" + siteSettings.performers.ajaxLoadingId).fadeIn();
                    var o = parseInt($("#" + siteSettings.performers.pageNumberId).val())
                      , i = JSON.parse(JSON.stringify(filter_ajax));
                    i.pagenum = o,
                    o++,
                    $.ajax({
                        type: "POST",
                        ...
                        success: function(e) {
                            if (e.length > 10) {
                                for (var t = /user_div/gi; null !== t.exec(e); )
                                    1;
                                globalPagesLoaded += 1,
                                $("#" + siteSettings.performers.loadMoreButtonId).hide(),
                                $("#" + siteSettings.performers.ajaxLoadingId).fadeOut(),
                                $("<span></span>" + e).insertBefore($("#" + siteSettings.performers.ajaxLoadingWrapperId)),
                                updateThumbnailHovers(),
                                "function" == typeof reloadPlugins && reloadPlugins(),
                                null != e && "" != e.trim() && $("#" + siteSettings.performers.pageNumberId).val(o.toString()),
                                setTimeout(function() {
                                    isLoading = !1
                                }, 300)
                            } else
                ...
                !0 === siteSettings.thumbnails.isDynamicPreviewActive && ("function" == typeof reloadPlugins && reloadPlugins(),
                setTimeout(updateThumbnailHovers, 500))
    }),
    !0 === siteSettings.thumbnails.isDynamicPreviewActive && !1 === siteSettings.performers.isLoadMoreButtonActive) {
        var e = !1
          , t = null;
        document.getElementById(siteSettings.performers.ajaxWrapperId) ? (t = document.getElementById(siteSettings.performers.ajaxWrapperId),
        e = !0) : document.getElementsByClassName(siteSettings.performers.ajaxWrapperId) && (t = document.getElementsByClassName(siteSettings.performers.ajaxWrapperId)[0],
        e = !0),
        e && t.addEventListener("click", function() {
            setTimeout(updateThumbnailHovers, 500),
            setInterval(updateThumbnailHovers, 1e3),
            "function" == typeof reloadPlugins && reloadPlugins()
        })
    }
});
